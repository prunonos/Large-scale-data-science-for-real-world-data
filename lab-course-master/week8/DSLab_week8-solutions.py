...
consumer = tt.get_simple_consumer(consumer_group='test-group-' + username, 
                                  auto_offset_reset=OffsetType.EARLIEST, auto_commit_enable=True, reset_offset_on_start=False, auto_commit_interval_ms=2000)
